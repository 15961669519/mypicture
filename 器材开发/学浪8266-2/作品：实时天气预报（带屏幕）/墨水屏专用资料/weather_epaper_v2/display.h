...
void resultDisplay() {
  ...
  do
  {
    ...
    u8g2Fonts.drawUTF8(0, 100, icon(wtd[1].iconDay));
    ...
    String weather_tmr = wtd[1].textDay + " " + wtd[1].tempMin + "°C 至 " + wtd[1].tempMax + "°C";
    u8g2Fonts.drawUTF8(50, 60 + 14, weather_tmr.c_str());

    String wind_tmr = wtd[1].windDirDay + wtd[1].windSpeedDay + "/Km 湿 " + String(wtd[1].humidity) + "%";
